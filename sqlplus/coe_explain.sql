/*$Header: coe_xplain.sql 8.1-9.0 156958.1 2002/11/12           csierra coe $*/
SET term off;
/*=============================================================================
...
coe_xplain.sql - Enhanced Explain Plan for given SQL Statement (8.1-9.0)
    ...
    * WARNING:                                                                *
    * =======                                                                 *
    * This is the terminal version of this script.  Its functionality is now  *
    * provided by SQLTXPLAIN.SQL and SQLTSTATTAB.SQL (see Note:215187.1).     *
    * In the future, please use the SQLT scripts instead.                     *
    * If for any reason you cannot use SQLTXPLAIN.SQL, or you get any error   *
    * during its initial installation, please email carlos.sierra@oracle.com  *
    ***************************************************************************
...
14. For Oracle 8.1-9.2 use SQLTXPLAIN.SQL from Note:215187.1
...
COLUMN query_plan FORMAT a140 HEADING -
       'Explain Plan by coe_xplain.sql 8.1/9.0 2002/11/12 Note:156958.1' wor;
...
BEGIN
    IF SUBSTR(:dbversion,1,5) IN ('8.1.6','8.1.7','9.0.1') THEN
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_optimizer_mode_force',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_optimizer_undo_changes',null,'FALSE','DO NOT SET','FALSE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_shared_pool_reserved_min_alloc',null,'DO NOT SET','4100-5000','5000');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_system_trig_enabled',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('db_block_buffers',null,'5000 or more','300+ MB','48 MB');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('log_buffer',null,'1048576 or more','3 MB','524288');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('open_cursors',null,'500',null,'50');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('optimizer_index_caching',null,'0','DO NOT SET','0');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('optimizer_index_cost_adj',null,'100','DO NOT SET','100');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('optimizer_mode',null,'CHOOSE',null,'CHOOSE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('optimizer_percent_parallel',null,'0','DO NOT SET','0');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('row_locking',null,'ALWAYS','DO NOT SET','ALWAYS');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('shared_pool_reserved_size',null,null,'10% shared_pool',
                                                '5% shared_pool');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('shared_pool_size',null,null,'350000000','16 or 64 MB');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
    ...
    IF SUBSTR(:dbversion,1,5) IN ('8.1.6','8.1.7') THEN
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('always_anti_join',null,'NESTED_LOOPS','DO NOT SET','NESTED_LOOPS');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('always_semi_join',null,'NESTED_LOOPS','DO NOT SET','NESTED_LOOPS');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('max_dump_file_size',null,null,'UNLIMITED','5 MB');
    END IF;
    IF SUBSTR(:dbversion,1,5) IN ('8.1.7','9.0.1') THEN
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_or_expand_nvl_predicate',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_use_column_stats_for_function',null,'TRUE','DO NOT SET','TRUE');
    END IF;
    ...
    IF SUBSTR(:dbversion,1,5) = '9.0.1' THEN
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_always_anti_join',null,'CHOOSE','DO NOT SET','CHOOSE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_always_semi_join',null,'CHOOSE','DO NOT SET','CHOOSE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_complex_view_merging',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_new_initial_join_orders',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_ordered_nested_loop',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_push_join_predicate',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_push_join_union_view',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_sort_elimination_cost_ratio',null,'0','DO NOT SET','0');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_sortmerge_inequality_join_off',null,'FALSE','DO NOT SET','FALSE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_sqlexec_progression_cost',null,'1000','DO NOT SET','1000');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('_unnest_subquery',null,'TRUE','DO NOT SET','TRUE');
       INSERT INTO COE_PARAMETERS_XYZ VALUES
       ...
       INSERT INTO COE_PARAMETERS_XYZ VALUES
        ('optimizer_max_permutations',null,'2000','DO NOT SET','2000');
    END IF;
END;
/
...
PRO * WARNING:                                                                *
PRO * =======                                                                 *
PRO * This is the terminal version of this script.  Its functionality is now  *
PRO * provided by SQLTXPLAIN.SQL and SQLTSTATTAB.SQL (see Note:215187.1).     *
PRO * In the future, please use the SQLT scripts instead.                     *
PRO * If for any reason you cannot use SQLTXPLAIN.SQL, or you get any error   *
PRO * during its initial installation, please email carlos.sierra@oracle.com  *
PRO ***************************************************************************
PRO
...
SELECT -- IV.c EXTENTS
    FILE_ID,
    BLOCK_ID BLOCK_FROM,
    (BLOCK_ID + BLOCKS - 1) BLOCK_TO,
    BLOCKS,
    EXTENT_ID,
    OWNER||'.'||SEGMENT_NAME||
    DECODE(PARTITION_NAME,NULL,NULL,'.'||PARTITION_NAME) SEGMENT_NAME,
    SEGMENT_TYPE
FROM
    COE_EXTENTS_XYZ
ORDER BY
