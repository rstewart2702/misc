...
rem column operation format a115 wrap
column operation format a150 wrap
rem column operation format a80 wrap
rem column operation format a105 wrap
rem column operation format a90 truncate
...
column position format 9999999 justify right heading 'posi-|tion'
column optimizer format a12 justify left
column distribution format a20 
column partition_start format a15 word justify left heading 'prtn|start'
column partition_stop format a15 word justify left heading 'prtn|stop'
...
column temp_space format 9999999
column cpu_cost format 9999999
column io_cost format 9999999
set linesize 400
set verify off
...
select id, object_node, other, other_tag
from plan_table
